...
import { actionStatusSchema, revertClassSchema } from "./action-status.js";
import { actionOutcomeSchema, preparedActionV1Schema } from "./actions.js";
import { baseUnitStringSchema } from "./amounts.js";
import { apiErrorSchema } from "./errors.js";
import { evidenceReportV1Schema } from "./evidence.js";
import {
  addressSchema,
  blockHashSchema,
...
import { policyEvaluationSchema, policyV1Schema } from "./policy.js";
import { vaultStatusSchema } from "./observations.js";

/**
 * The HTTP contract.
 *
 * Lives in the domain package rather than beside the routes because three consumers parse through
 * it: the Hono app in both directions, the MCP tools that dispatch into it, and the web app that
 * reads it over the wire. A browser cannot import the API app to get these shapes — that would pull
 * Hono, drizzle and viem into the bundle — and a second copy is the duplication the OpenAPI drift
